...
const listVariants: Record<TabsVariant, string> = {
  default:
    // Vertical: vira uma lista de navegacao (sem trilho cinza), como o menu lateral.
    "inline-flex h-9 items-center justify-center rounded-lg bg-[hsl(var(--muted-foreground)/0.10)] p-1 text-muted-foreground overflow-x-auto scroll-smooth scrollbar-hide data-[orientation=vertical]:h-auto data-[orientation=vertical]:w-full data-[orientation=vertical]:flex-col data-[orientation=vertical]:items-stretch data-[orientation=vertical]:justify-start data-[orientation=vertical]:gap-0.5 data-[orientation=vertical]:rounded-none data-[orientation=vertical]:bg-transparent data-[orientation=vertical]:p-0 data-[orientation=vertical]:overflow-x-visible",
  underline:
    "flex h-auto w-full items-center justify-start gap-6 rounded-none border-b border-border bg-transparent p-0 text-muted-foreground overflow-x-auto scroll-smooth scrollbar-hide data-[orientation=vertical]:h-auto data-[orientation=vertical]:w-full data-[orientation=vertical]:flex-col data-[orientation=vertical]:items-stretch data-[orientation=vertical]:justify-start data-[orientation=vertical]:overflow-x-visible data-[orientation=vertical]:border-b-0 data-[orientation=vertical]:border-r",
}

const triggerVariants: Record<TabsVariant, string> = {
  default:
    "inline-flex items-center justify-center whitespace-nowrap rounded-md px-3 py-1 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:text-foreground data-[state=active]:bg-card data-[state=active]:text-foreground data-[state=active]:shadow-sm dark:data-[state=active]:bg-[hsl(var(--foreground)/0.10)] data-[orientation=vertical]:w-full data-[orientation=vertical]:justify-start data-[orientation=vertical]:gap-2 data-[orientation=vertical]:px-3 data-[orientation=vertical]:py-2 data-[orientation=vertical]:text-left data-[orientation=vertical]:hover:bg-accent data-[orientation=vertical]:data-[state=active]:bg-primary/10 data-[orientation=vertical]:data-[state=active]:text-primary data-[orientation=vertical]:data-[state=active]:shadow-none dark:data-[orientation=vertical]:data-[state=active]:bg-primary/20",
  underline:
