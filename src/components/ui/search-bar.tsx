    ...
    if (asButton) {
      return (
        <button
          ...
          className={cn(
            "relative flex h-9 items-center rounded-md border border-input bg-background pl-9 pr-3 text-left text-sm text-muted-foreground shadow-sm transition-colors hover:bg-accent dark:hover:bg-accent/80",
            className
          )}
        >
